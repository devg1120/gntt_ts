...
function getDecade(d: any) {
    const year = d.getFullYear();
    return year - (year % 10) + '';
}

function formatWeek(d: any, ld: any, lang: any) {
...
const DEFAULT_VIEW_MODES = [
    {
        ...
        lower_text: 'mm',
        upper_text: (d: any, ld: any, lang: any) =>
    ...
    },
    {
        ...
        step: '1d',
        lower_text: (d: any, ld: any, lang: any) =>
            !ld || d.getDate() !== ld.getDate()
                ? date_utils.format(d, 'D', lang)
                : '',
        upper_text: (d: any, ld: any, lang: any) =>
    ...
    },
    {
        ...
        upper_text: (d: any, ld: any, lang: any) =>
            !ld || d.getMonth() !== ld.getMonth()
                ? date_utils.format(d, 'MMMM', lang)
                : '',
        thick_line: (d: any) => d.getDate() >= 1 && d.getDate() <= 7,
        upper_text_frequency: 4,
    },
    {
        name: 'Month',
        ...
        upper_text: (d: any, ld: any, lang: any) =>
            !ld || d.getFullYear() !== ld.getFullYear()
                ...
                : '',
        thick_line: (d: any) => d.getMonth() % 3 === 0,
        snap_at: '7d',
    },
    {
        name: 'Year',
