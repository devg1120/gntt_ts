 ...
 */
export function detectCycles(relationships: any) {
 ...
 */
export function findFixedLinks(taskId: any, relationships: any, visited = new Set()) {
 ...
 */
export function calculatePushAmount(type: any, predTask: any, succTask: any, lagPx: any, predNewX: any) {
...
export function resolveMovement(
    ...
    // @ts-expect-error TS(2339): Property 'pixelsPerTimeUnit' does not exist on typ... Remove this comment to see the full error message
