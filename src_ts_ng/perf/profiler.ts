...
if (typeof window !== 'undefined') {
    // @ts-expect-error TS(2339): Property 'prof' does not exist on type 'Window & t... Remove this comment to see the full error message
    window.prof = prof;
}
