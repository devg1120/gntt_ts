 ...
 * Call node structure
 */
function createCallNode(name: any, args: any) {
    return {
        id: ++callId,
        name,
 ...
 */
export function instrument(fn: any, name: any) {
    return function instrumented(this: any, ...args: any[]) {
        if (!isRecording) {
 ...
 */
export function instrumentObject(obj: any, prefix: any, methodNames: any) {
...
export function analyzeCallTree() {
    ...
    function traverse(nodes: any) {
        for (const node of nodes) {
            ...
            const childTime = node.children.reduce((sum: any, c: any) => sum + (c.duration || 0), 0);
...
export function formatCallTree(maxDepth = 10) {
    ...
    function traverse(nodes: any, depth: any) {
...
if (typeof window !== 'undefined') {
    // @ts-expect-error TS(2339): Property '__callTree' does not exist on type 'Wind... Remove this comment to see the full error message
    window.__callTree = {
        startRecording,
        stopRecording,
        clearRecording,
