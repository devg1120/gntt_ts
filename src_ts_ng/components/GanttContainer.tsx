...
// @ts-expect-error TS(2307): Cannot find module '@solid-primitives/scheduled' o... Remove this comment to see the full error message
import { throttle } from '@solid-primitives/scheduled';

// Global debug object for scroll timing (accessible by perf demo)
if (typeof window !== 'undefined') {
    // @ts-expect-error TS(2339): Property '__ganttScrollDebug' does not exist on ty... Remove this comment to see the full error message
 ...
 */
export function GanttContainer(props: any) {
    let scrollAreaRef: any;
    let svgRef: any;
    let dateHeadersRef: any;
    let resourceBodyRef: any;
    ...
    const scrollTo = (x: any, smooth = true) => {
        if (scrollAreaRef) {
            if (smooth) {
