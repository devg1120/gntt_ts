...
export function Bar(props: any) {
    ...
    const { dragState, isDragging, startDrag } = useDrag({
        onDragStart: (data: any, state: any) => {
        ...
        onDragMove: (move: any, data: any, state: any) => {
            ...
            if (state === 'dragging_bar') {
                ...
                const totalIgnoredInBar = ignored.reduce((acc: any, pos: any) => {
                ...
                const ignoredInProgress = ignored.reduce((acc: any, pos: any) => {
        ...
        onDragEnd: (move: any, data: any, state: any) => {
