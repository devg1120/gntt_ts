 ...
 */
function autoStartAnchor(from: any, to: any, depType: any) {
 ...
 */
function autoEndAnchor(from: any, to: any, depType: any) {
    const dy = to.y + to.height / 2 - (from.y + from.height / 2);
    const sameRow = Math.abs(dy) <= DEFAULTS.ALIGNMENT_THRESHOLD;
 ...
 */
function smartOffset(from: any, to: any, anchor: any, curve: any, depType: any) {
 ...
 */
function generateLinePath(start: any, end: any, startAnchor: any, endAnchor: any, curve: any) {
 ...
 */
function generateHeadPath(end: any, endAnchor: any, size: any) {
    if (size <= 0) return '';
 ...
 */
function generateArrow(from: any, to: any, depType: any, curve: any, headSize: any) {
    // Resolve anchors
...
export function ArrowLayerBatched(props: any) {
