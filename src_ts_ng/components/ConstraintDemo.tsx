 ...
 */
function findFixedOffsetLinks(taskId: any, relationships: any, visited = new Set()) {
 ...
 */
function calculateDistance(predTask: any, succTask: any, predNewX = null) {
 ...
 */
function resolveMovement(taskId: any, newX: any, newY: any, taskStore: any, relationships: any, depth = 0) {
            ...
            <div style={{
                ...
                <label style={{ display: 'flex', 'align-items': 'center', gap: '8px' }}>
                    ...
                    <select
                        ...
                        onChange={(e: any) => { setSelectedScenario(e.target.value); updateTasks(); }}
                            ...
                            return (
                                ...
                                <g>
                                    ...
                                    <rect
                                        ...
                                        onMouseDown={(e: any) => handleMouseDown(task.id, e)}
                                    />
                                    // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                                    <text
