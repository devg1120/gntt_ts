 ...
 */
function getAnchorPoint(bar: any, anchor: any, offset = 0.5) {
 ...
 */
function hasHorizontalOverlap(from: any, to: any) {
 ...
 */
function autoSelectStartAnchor(from: any, to: any, dependencyType = 'FS') {
 ...
 */
function autoSelectEndAnchor(from: any, to: any, dependencyType = 'FS') {
    const fromCenterY = from.y + from.height / 2;
    const toCenterY = to.y + to.height / 2;
    const dy = toCenterY - fromCenterY;
    const sameRow = Math.abs(dy) <= DEFAULTS.ALIGNMENT_THRESHOLD;
 ...
 */
function generateArrowHeadRight(shape: any, size: any, fill: any) {
 ...
 */
function straightPath(start: any, end: any) {
 ...
 * Returns just the line path (no arrow head).
 */
function orthogonalPath(start: any, end: any, startAnchor: any, endAnchor: any, curveRadius: any) {
 ...
 * Returns just the line path (no arrow head).
 */
function verticalToVerticalPath(start: any, end: any, curve: any) {
    const dx = end.x - start.x;
    const dy = end.y - start.y;
 ...
 * Returns just the line path (no arrow head).
 */
function verticalToHorizontalPath(start: any, end: any, startAnchor: any, endAnchor: any, curve: any) {
    const dy = end.y - start.y;
 ...
 * Returns just the line path (no arrow head).
 */
function verticalFirstPath(start: any, end: any, curve: any) {
    const dy = end.y - start.y;
    const goingUp = dy < 0;
 ...
 * Returns just the line path (no arrow head).
 */
function horizontalFirstPath(start: any, end: any, curve: any) {
    const dx = end.x - start.x;
    const dy = end.y - start.y;
    const goingUp = dy < 0;
 ...
 */
function getArrowHeadDirection(endAnchor: any) {
    switch (endAnchor) {
        case 'top':
...
function generatePath(from: any, to: any, config: any) {
...
export function Arrow(props: any) {
    ...
    const getAdjustedPosition = (taskId: any) => {
