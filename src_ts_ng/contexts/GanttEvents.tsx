 ...
 */
export function GanttEventsProvider(props: any) {
    const handlers = {
        onDateChange: (taskId: any, position: any) => props.onDateChange?.(taskId, position),
        onProgressChange: (taskId: any, progress: any) => props.onProgressChange?.(taskId, progress),
        onResizeEnd: (taskId: any) => props.onResizeEnd?.(taskId),
        onTaskClick: (taskId: any, event: any) => props.onTaskClick?.(taskId, event),
        onHover: (taskId: any, clientX: any, clientY: any) => props.onHover?.(taskId, clientX, clientY),
