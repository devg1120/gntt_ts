...
export function ArrowDemo() {
    ...
    const handleMouseDown = (taskId: any, event: any) => {
                    ...
                    <fieldset style={{ border: '1px solid #dee2e6', padding: '10px', 'border-radius': '4px' }}>
                        ...
                        <label style={{ display: 'block', 'margin-bottom': '8px' }}>
                            ...
                            <select
                                ...
                                onChange={(e: any) => setConfig({ ...config(), startAnchor: e.target.value })}
                        ...
                        <label style={{ display: 'block', 'margin-bottom': '8px' }}>
                            ...
                            <input
                                ...
                                onInput={(e: any) => setConfig({ ...config(), startOffset: parseFloat(e.target.value) })}
                                style={{ width: '100%' }}
                            />
                        // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                        </label>
                        ...
                        <label style={{ display: 'block' }}>
                            ...
                            <select
                                ...
                                onChange={(e: any) => setConfig({ ...config(), endAnchor: e.target.value })}
                                style={{ width: '100%', padding: '4px', 'margin-top': '2px' }}
                            >
                                // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                                <option value="left">Left</option>
                    ...
                    <fieldset style={{ border: '1px solid #dee2e6', padding: '10px', 'border-radius': '4px' }}>
                        ...
                        <label style={{ display: 'block', 'margin-bottom': '8px' }}>
                            ...
                            <select
                                ...
                                onChange={(e: any) => setConfig({ ...config(), routing: e.target.value })}
                                style={{ width: '100%', padding: '4px', 'margin-top': '2px' }}
                            >
                                // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                        ...
                        <label style={{ display: 'block' }}>
                            ...
                            <input
                                ...
                                onInput={(e: any) => setConfig({ ...config(), curveRadius: parseInt(e.target.value) })}
                                style={{ width: '100%' }}
                            />
                        // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                        </label>
                    ...
                    <fieldset style={{ border: '1px solid #dee2e6', padding: '10px', 'border-radius': '4px' }}>
                        ...
                        <label style={{ display: 'flex', 'align-items': 'center', gap: '8px', 'margin-bottom': '8px' }}>
                            ...
                            <input
                                type="color"
                                value={config().stroke}
                                onInput={(e: any) => setConfig({ ...config(), stroke: e.target.value })}
                        ...
                        <label style={{ display: 'block', 'margin-bottom': '8px' }}>
                            ...
                            <input
                                ...
                                onInput={(e: any) => setConfig({ ...config(), strokeWidth: parseFloat(e.target.value) })}
                                style={{ width: '100%' }}
                            />
                        // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                        </label>
                        ...
                        <label style={{ display: 'block', 'margin-bottom': '8px' }}>
                            ...
                            <input
                                ...
                                onInput={(e: any) => setConfig({ ...config(), strokeOpacity: parseFloat(e.target.value) })}
                                style={{ width: '100%' }}
                            />
                        // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                        </label>
                        ...
                        <label style={{ display: 'block' }}>
                            ...
                            <select
                                ...
                                onChange={(e: any) => setConfig({ ...config(), strokeDasharray: e.target.value })}
                                style={{ width: '100%', padding: '4px', 'margin-top': '2px' }}
                            >
                                // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                    ...
                    <fieldset style={{ border: '1px solid #dee2e6', padding: '10px', 'border-radius': '4px' }}>
                        ...
                        <label style={{ display: 'block', 'margin-bottom': '8px' }}>
                            ...
                            <select
                                ...
                                onChange={(e: any) => setConfig({ ...config(), headShape: e.target.value })}
                                style={{ width: '100%', padding: '4px', 'margin-top': '2px' }}
                            >
                                // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                        ...
                        <label style={{ display: 'block', 'margin-bottom': '8px' }}>
                            ...
                            <input
                                ...
                                onInput={(e: any) => setConfig({ ...config(), headSize: parseInt(e.target.value) })}
                                style={{ width: '100%' }}
                            />
                        // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                        </label>
                        ...
                        <label style={{ display: 'flex', 'align-items': 'center', gap: '8px' }}>
                            ...
                            <input
                                ...
                                onChange={(e: any) => setConfig({ ...config(), headFill: e.target.checked })}
                            />
                            // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                            ...
                            return (
                                ...
                                <g>
                                    ...
                                    <rect
                                        ...
                                        onMouseDown={(e: any) => handleMouseDown(scenario.id, e)}
                                    />
                                    {scenario.name && (
                                        // @ts-expect-error TS(7026): JSX element implicitly has type 'any' because no i... Remove this comment to see the full error message
                                        <text
