 ...
 */
export async function runScrollBenchmark(scrollContainer: any, options = {}) {
    const {
        // @ts-expect-error TS(2339): Property 'duration' does not exist on type '{}'.
        duration = 3000,
        // @ts-expect-error TS(2339): Property 'scrollSpeed' does not exist on type '{}'... Remove this comment to see the full error message
        scrollSpeed = 10,
...
if (typeof window !== 'undefined') {
    // @ts-expect-error TS(2339): Property '__ganttPerf' does not exist on type 'Win... Remove this comment to see the full error message
    window.__ganttPerf = {
        // @ts-expect-error TS(2591): Cannot find name 'require'. Do you need to install... Remove this comment to see the full error message
