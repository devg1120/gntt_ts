 ...
 */
function generateTaskId(task: any, index: any) {
 ...
 */
export function processTask(task: any, index: any) {
 ...
 */
export function processTasks(tasks: any, config: any, externalResourceIndexMap = null) {
 ...
 */
export function findDateBounds(tasks: any) {
    let minDate = null;
    let maxDate = null;
 ...
 */
export function buildDependencyMap(tasks: any) {
    const map = new Map();
