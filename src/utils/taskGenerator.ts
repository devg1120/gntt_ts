 ...
 */
export function getResourceLabel(index: any) {
    let label = '';
    let n = index;
    do {
 ...
 */
export function parseDateTime(dateStr: any) {
 ...
 * Add hours to a date
 */
export function addHours(dateOrStr: any, hours: any) {
    const date =
 ...
 * Clone a Date object
 */
export function cloneDate(date: any) {
 ...
 */
export function calculateTaskTimes(startDate: any, durationHours: any, workdayStart: any, workdayEnd: any) {
 ...
 */
function randomBetween(random: any, min: any, max: any) {
 ...
 */
function shuffleArray(random: any, array: any) {
    const result = [...array];
 ...
 */
function generateDenseCalendar(cfg: any, random: any) {
    const tasks = [];
 ...
 */
function findValidPredecessor(tasks: any, resource: any, beforeDate: any) {
    const candidates = tasks.filter(
        (t: any) => t.resource === resource && parseDateTime(t.end) <= beforeDate
    );
 ...
 */
function generateRealisticCalendar(cfg: any, random: any) {
    const tasks = [];
