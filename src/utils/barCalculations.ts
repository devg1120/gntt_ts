 ...
 */
export function computeX(taskStart: any, ganttStart: any, unit: any, step: any, columnWidth: any) {
 ...
 */
export function computeY(taskIndex: any, barHeight: any, padding: any) {
 ...
 */
export function computeWidth(taskStart: any, taskEnd: any, unit: any, step: any, columnWidth: any) {
 ...
 */
export function daysToUnits(days: any, unit: any, step: any) {
 ...
 */
export function computeExpectedProgress(taskStart: any, taskEnd: any, unit: any, step: any) {
 ...
 * @returns {boolean}
 */
export function isIgnoredPosition(x: any, ignoredPositions: any, columnWidth: any) {
    return ignoredPositions.some((pos: any) => x >= pos && x < pos + columnWidth);
}
 ...
 */
export function snapToGrid(x: any, columnWidth: any, ignoredPositions = []) {
 ...
 */
export function computeLabelPosition(barX: any, barWidth: any, labelText: any, charWidth = 7) {
 ...
 */
export function calculateDistance(predBar: any, succBar: any) {
 ...
 */
export function computeSummaryBounds(summaryTask: any, taskMap: any, minWidth = 20) {
    if (!summaryTask._children || summaryTask._children.length === 0) {
        return null;
    }

    // Helper to get task (supports both Map and plain object)
    const getTask = taskMap.get ? (id: any) => taskMap.get(id) : (id: any) => taskMap[id];

    // Collect all descendant bars (recursive) for accurate span calculation
    const descendantBars: any = [];
    const collectBars = (childIds: any) => {
 ...
 */
export function recomputeAllSummaryBounds(taskMap: any) {
    // Find max depth
    let maxDepth = 0;
 ...
 */
export function computeVariableY(rowId: any, rowLayouts: any, fallbackY = 0) {
 ...
 */
export function computeSubtaskBarHeight(barHeight: any, ratio = 0.5) {
 ...
 */
export function computeExpandedRowHeight(task: any, isExpanded: any, config: any) {
